...
isc.version = "v11.0p_2016-05-23/EVAL Deployment";
isc.versionNumber = "v11.0p_2016-05-23";
isc.buildDate = "2016-05-23";
isc.expirationDate = "2016.07.22_06.27.01";
...
cacheLocale:function(locale,onload){
    ...
    this._queueFiles(localeFile,onload,"js",{cacheOnly:true,addVersionToLoadTags:true});
},
...
loadLocale:function(locale,onload){
    ...
    var localeFile=window.isomorphicDir+"locales/frameworkMessages"
             +((locale=="en")?"":"_"+locale)+".properties";
    this._queueFiles(localeFile,onload,"js",{defer:true,addVersionToLoadTags:true});
},
