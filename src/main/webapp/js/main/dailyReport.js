isc.ListGrid.create({
    ID: "dailyReport",
    width:"100%", height:"30%", alternateRecordStyles:true, 
    fields:[
            {name:"sessionID", title:"ID"},
            {name:"phone", title:"Phone"},
            {name:"personalNumber", title:"P_Num"},
            {name:"policyNumber", title:"PolicyNum"},
            {name:"name", title:"Name"},
            {name:"createDate", title:"CreateDate", type:"datetime", width:100},
