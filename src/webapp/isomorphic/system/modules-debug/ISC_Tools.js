...
isc.A.readOnlyHover="Add a DataSource to enable";
...
,isc.A.createMethodGroups=function isc_ComponentEditor_createMethodGroups(groups,dataSource){
            ...
            !isc.isAn.emptyObject(classObj._stringMethodRegistry))
        {
            ...
            for(var i=0;i<chain.length;i++){
                ...
                classMethods=currentClassObj._stringMethodRegistry._entries.duplicate();
        ...
        for(var i=0;i<editableFields.length;i++){
            ...
            if(item.requiresDSField){
                item.readOnlyWhen={
                    ...
                    operator:"and",
                    criteria:[
                        {fieldName:this.ID+".values."+item.requiresDSField,operator:"isNull"}
                    ]
                };
                item.readOnlyHover=this.readOnlyHover;
            }
