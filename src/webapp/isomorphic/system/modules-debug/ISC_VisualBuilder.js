...
isc.A.dataSourceListDefaults={
    ...
    editSelectedDataSource:function(){
        ...
        if(record)isc.DS.get(record.ID,this.creator.getID()+".showDSEditor(ds)");
    },
    ...
    cellClick:function(record,rowNum,colNum){
        var field=this.getField(colNum);
        if(field.name=="download"){
            isc.DS.get(record.ID,this.creator.getID()+".downloadDataSource(ds)");
    ...
    dsContextMenuDefaults:{
        ...
        data:[{
            ...
            click:function(target,item,menu){
                isc.DS.get(menu._record.ID,menu.creator.creator.getID()+".showDSEditor(ds)");
            }
        },{
...
isc.evalBoundary;isc.B.push(isc.A.setCurrentScreen=function isc_VisualBuilder_setCurrentScreen(newScreen){
...
,isc.A.updateRecentVersionsMenu=function isc_VisualBuilder_updateRecentVersionsMenu(menu,item,enabled){
    var undef,
        builder=this,
...
,isc.A.showScreenUI=function isc_VisualBuilder_showScreenUI(){
    ...
    if(mockupMode){
        ...
        if(this.rootLiveObject.editProxy)this.rootLiveObject.editProxy.persistCoordinates=false;
...
,isc.A.showDataSourcePicker=function isc_VisualBuilder_showDataSourcePicker(){
    ...
    this.dataSourcePicker.showLoadFileUI(function(dsResponse,data,dsRequest){
        isc.DS.get(data.fileName,function(ds){
...
,isc.A.downloadDataSource=function isc_VisualBuilder_downloadDataSource(ds){
    var vb=this;
...
,isc.A.showDSEditor=function isc_VisualBuilder_showDSEditor(dataSource,isNew,instructions){
    var _this=this,
...
isc.evalBoundary;isc.B.push(isc.A.hideRightMostResizeBar=function isc_VisualBuilder_hideRightMostResizeBar(){
