...
if(isc.Log && isc.Log.logDebug)isc.Log.logDebug(isc._pTM.message,'loadTime');
...
else isc._preLog=[isc._pTM]}isc.definingFramework=true;if(window.isc&&isc.version!="v11.0p_2016-05-23/EVAL Deployment"&&!isc.DevUtil){
    isc._optionalModuleCompare=function(){
        ...
        if(isc.version.toLowerCase().contains("pro")||isc.version.toLowerCase().contains("lgpl")){
            ...
            var moduleVersion="v11.0p_2016-05-23/EVAL Deployment";
...
isc.evalBoundary;isc.B.push(isc.A.showFacetValues=function isc_CubeGrid_showFacetValues(facetValues){
...
isc.evalBoundary;isc.B.push(isc.A.handleUpdate=function isc_CubeGrid_handleUpdate(data,dsRequest,dsReponse){
